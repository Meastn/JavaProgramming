...
public class Grader {
    public static void main(String[] args) {
        ...
        double score6 = scan.nextDouble();

        System.out.println("Summary: " + subject1 + " - " + score1 + ", " + subject2 + " - " + score2 + ", " + subject3 + " - " + score3 + ", " + subject4 + " - " + score4 + ", " + subject5 + " - " + score5 + ", " + subject6 + " - " + score6);
        System.out.println("Your average score is: " + ((score1 + score2 + score3 + score4 + score5 + score6) / 6));
