...
public class PolymorphismPractice {
    public static void main(String[] args) {
        ...
        Car[] cars = {
                ...
                new Toyota("Avalan", 2019, 35000, "Blue", 175230),
        ...
        Car carWithMileage = cars[0], carWithLowestMileage = cars [0];

        for (Car eachCar : cars) {
            if (eachCar.miles > carWithMileage.miles)
                carWithMileage=eachCar;
        }
        System.out.println("Car with highest mileage: " + carWithMileage);
        System.out.println("---------------------");
        for (Car eachCar : cars) {
        ...
        System.out.println("Car with lowest mileage: " + carWithLowestMileage);
    }
...
1,4 Write a program that can display the car tha has the lowest mileage
 */